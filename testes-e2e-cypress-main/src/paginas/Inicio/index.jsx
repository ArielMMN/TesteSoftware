          ...
          <div className={estilos.vantagens}>
            ...
            <div className={estilos.vantagens__itens}>
              ...
              <div className={estilos.vantagens__item}>
                ...
                <h3 data-test="legenda-saque">Saques sem custo</h3>
                <p data-test="paragrafo-saque">
              ...
              <div className={estilos.vantagens__item}>
                ...
                <h3 data-test="legenda-ponto">Programa de pontos</h3>
                <p data-test="paragrafo-ponto">
              ...
              <div className={estilos.vantagens__item}>
                ...
                />
                <h3 data-test="legenda-seguro">Seguro Dispositivos</h3>
                <p data-test="paragrafo-seguro">
